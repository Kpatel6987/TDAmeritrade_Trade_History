# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-08-30 01:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pl', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('commission', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
                ('net_gain', models.DecimalField(decimal_places=2, default=0.0, max_digits=10)),
